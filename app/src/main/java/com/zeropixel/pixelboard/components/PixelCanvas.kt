package com.zeropixel.pixelboard.components
...
import com.zeropixel.pixelboard.utils.toImageBitmap
...
fun PixelCanvas(
    ...
    layers: List<com.zeropixel.engine.Layer>,
            ...
            Box(
                ...
                Image(
                    ...
                    painter = BitmapPainter(
                        image = backgroundBitmap.toImageBitmap(),
                ...
                layers.forEach { layer ->
                    if (layer.visible) {
                        Image(
                            ...
                            painter = BitmapPainter(
                                image = layer.bitmap.toImageBitmap(),
                                filterQuality = FilterQuality.None,
                            ),
